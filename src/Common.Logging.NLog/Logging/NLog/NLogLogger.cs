...
namespace Common.Logging.NLog
{
    ...
    public class NLogLogger : AbstractLogger
    {
        ...
        private static readonly Assembly nlogAssembly = typeof (LoggerNLog).Assembly;
        ...
        private static readonly Assembly commonLogAssembly = typeof (AbstractLogger).Assembly;
        private static readonly Assembly commonLogNLogAssembly = typeof (NLogLogger).Assembly;
        ...
        private static int FindCallingMethodOnStackTrace(StackTrace stackTrace, Type loggerType)
        {
            ...
            for (int i = 0; i < stackTrace.FrameCount; ++i)
            {
                ...
                Assembly methodAssembly = mb.DeclaringType.Assembly;
        ...
        private static bool SkipAssembly(Assembly assembly)
        {
            ...
            if (assembly == commonLogAssembly)
                return true;

            if (assembly == commonLogNLogAssembly)
                return true;
